package com.brito.hexagonal.adapters.`in`.controller

import com.brito.hexagonal.adapters.`in`.controller.request.CustomerRequest
import com.brito.hexagonal.adapters.`in`.controller.response.CustomerResponse
